...
const enrichStrategyGroupInfoListByInstrumentPrices = (strategyGroupInfoList,tradedInstrumentList)=>{
  ...
  strategyGroupInfoList = strategyGroupInfoList.map(strategyGroupInfo=>{
    ...
    try {
      ...
      strategyGroupInfo.exerciseCost = (0,_common__WEBPACK_IMPORTED_MODULE_0__.calculateExerciseCost)({strategyPositions:strategyGroupInfo.strategyPositions,stockPrice:strategyGroupInfo.stockPrice});
